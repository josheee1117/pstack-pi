...
Fill in the placeholders. Append the single category recipe from `sources.md` that matches this investigator's category, and the incident angle when the target code looks defensive.
