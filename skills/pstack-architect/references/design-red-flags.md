...
Temporal decomposition organizes modules by execution order instead of by the knowledge they own. Separate load, validate, transform, and save stages often repeat one representation and its invariants across several boundaries.
